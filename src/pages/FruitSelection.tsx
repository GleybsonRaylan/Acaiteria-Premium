        ...
        {fruits.map((fruit) => (
          ...
          >
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-bold text-foreground">{fruit.name}</h3>
              {fruit.price > 0 && (
